...
func (s *websocketServiceTestSuite) TestPartialDepthServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsPartialDepthServe("ETHBTC", "5", func(event *WsPartialDepthEvent) {
...
func (s *websocketServiceTestSuite) TestPartialDepthServe100Ms() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsPartialDepthServe100Ms("ETHBTC", "5", func(event *WsPartialDepthEvent) {
		e := &WsPartialDepthEvent{
			Symbol:       "ETHBTC",
			LastUpdateID: 160,
			Bids: []Bid{
...
func (s *websocketServiceTestSuite) TestCombinedPartialDepthServe() {
	...
	defer s.assertWsServe()
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedPartialDepthServe(symbolLevels, func(event *WsPartialDepthEvent) {
		e := &WsPartialDepthEvent{
			Symbol:       "ETHUSDT",
			LastUpdateID: 160,
			Bids: []Bid{
...
func (s *websocketServiceTestSuite) TestDepthServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsDepthServe("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestDepthServe100Ms() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsDepthServe100Ms("ETHBTC", func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:         "depthUpdate",
			Time:          1499404630606,
			Symbol:        "ETHBTC",
...
func (s *websocketServiceTestSuite) TestCombinedDepthServe() {
	...
	defer s.assertWsServe()
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedDepthServe(symbols, func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Symbol:        "BTCUSDT",
			Time:          1629769560797,
...
func (s *websocketServiceTestSuite) TestCombinedDepthServe100Ms() {
	...
	defer s.assertWsServe()
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedDepthServe100Ms(symbols, func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Symbol:        "BTCUSDT",
			Time:          1629769560797,
			LastUpdateID:  13544037,
...
func (s *websocketServiceTestSuite) TestWsAggTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAggTradeServe("ETHBTC", func(event *WsAggTradeEvent) {
		e := &WsAggTradeEvent{
			Event:                 "aggTrade",
			Time:                  1499405254326,
			Symbol:                "ETHBTC",
...
func (s *websocketServiceTestSuite) TestWsCombinedAggTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedAggTradeServe([]string{"ETHBTC"}, func(event *WsAggTradeEvent) {
		e := &WsAggTradeEvent{
			Event:                 "aggTrade",
			Time:                  1499405254326,
			Symbol:                "ETHBTC",
...
func (s *websocketServiceTestSuite) TestWsMarketStatServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsMarketStatServe("BNBBTC", func(event *WsMarketStatEvent) {
		e := &WsMarketStatEvent{
			Event:              "24hrTicker",
			Time:               123456789,
			Symbol:             "BNBBTC",
...
func (s *websocketServiceTestSuite) TestWsCombinedMarketStatServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedMarketStatServe([]string{"BNBBTC"}, func(event *WsMarketStatEvent) {
		e := &WsMarketStatEvent{
			Event:              "24hrTicker",
			Time:               123456789,
			Symbol:             "BNBBTC",
...
func (s *websocketServiceTestSuite) TestWsAllMarketsStatServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllMarketsStatServe(func(event WsAllMarketsStatEvent) {
...
func (s *websocketServiceTestSuite) TestWsTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsTradeServe("BNBBTC", func(event *WsTradeEvent) {
		e := &WsTradeEvent{
			Event:         "trade",
			Time:          123456789,
			Symbol:        "BNBBTC",
...
func (s *websocketServiceTestSuite) TestWsCombinedTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedTradeServe([]string{"BNBBTC"}, func(event *WsCombinedTradeEvent) {
...
func (s *websocketServiceTestSuite) TestWsAllMiniMarketsStatServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllMiniMarketsStatServe(func(event WsAllMiniMarketsStatEvent) {
...
func (s *websocketServiceTestSuite) TestBookTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsBookTickerServe("BTCUSD_200626", func(event *WsBookTickerEvent) {
		e := &WsBookTickerEvent{
			UpdateID:     17242169,
...
func (s *websocketServiceTestSuite) TestWsAnnouncementServe() {
  ...
  "data": "{\"catalogId\":161,\"catalogName\":\"Delisting\",\"publishDate\":1753257631403,\"title\":\"Notice of...\",\"body\":\"This is...\",\"disclaimer\":\"Trade on-the-go...\"}"
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAnnouncementServe(WsAnnouncementParam{}, func(event *WsAnnouncementEvent) {
...
func (s *websocketServiceTestSuite) TestWsUserDataServeSignatureErrorWithEmptyCredentials() {
	...
	_, _, err := c.WsUserDataServeSignature(keyType, timeOffset, handler, errHandler)
