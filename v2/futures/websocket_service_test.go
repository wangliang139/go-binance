...
func (s *websocketServiceTestSuite) TestAggTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAggTradeServe("BTCUSDT", func(event *WsAggTradeEvent) {
		e := &WsAggTradeEvent{
			Event:            "aggTrade",
			Time:             123456789,
			Symbol:           "BTCUSDT",
...
func (s *websocketServiceTestSuite) TestCombinedAggTradeServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedAggTradeServe([]string{"BTCUSDT"}, func(event *WsAggTradeEvent) {
		e := &WsAggTradeEvent{
			Event:            "aggTrade",
			Time:             1628843331742,
			Symbol:           "BTCUSDT",
...
func (s *websocketServiceTestSuite) testMarkPriceServe(rate *time.Duration, expectedErr error, expectedServeCnt int) {
	...
	var err error
	if rate == nil {
		doneC, stopC, err = c.WsMarkPriceServe("BTCUSDT", handler, errHandler)
	} else {
		doneC, stopC, err = c.WsMarkPriceServeWithRate("BTCUSDT", *rate, handler, errHandler)
	}
...
func (s *websocketServiceTestSuite) testAllMarkPriceServe(rate *time.Duration, expectedErr error, expectedServeCnt int) {
	...
	var err error
	if rate == nil {
		doneC, stopC, err = c.WsAllMarkPriceServe(handler, errHandler)
	} else {
		doneC, stopC, err = c.WsAllMarkPriceServeWithRate(*rate, handler, errHandler)
	}
...
func (s *websocketServiceTestSuite) testCombinedMarkPriceServe(rate *time.Duration, expectedErr error, expectedServeCnt int) {
	...
	if rate == nil {
		...
		doneC, stopC, err = c.WsCombinedMarkPriceServe(input, handler, errHandler)
	} else {
		input := map[string]time.Duration{"BTCUSDT": *rate}
		doneC, stopC, err = c.WsCombinedMarkPriceServeWithRate(input, handler, errHandler)
	}
...
func (s *websocketServiceTestSuite) TestKlineServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsKlineServe("ETHBTC", "1m", func(event *WsKlineEvent) {
		e := &WsKlineEvent{
			Event:  "kline",
			Time:   123456789,
			Symbol: "BTCUSDT",
...
func (s *websocketServiceTestSuite) TestWsCombinedKlineServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedKlineServe(input, func(event *WsKlineEvent) {
		e := &WsKlineEvent{
			Event:  "kline",
			Time:   1499404907056,
			Symbol: "ETHBTC",
...
func (s *websocketServiceTestSuite) TestWsCombinedKlineServeMultiInterval() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedKlineServeMultiInterval(input, func(event *WsKlineEvent) {
		e := &WsKlineEvent{
			Event:  "kline",
			Time:   1499404907056,
			Symbol: "ETHBTC",
...
func (s *websocketServiceTestSuite) TestContinuousKlineServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsContinuousKlineServe(&WsContinuousKlineSubscribeArgs{
		Pair:         "BTCUSDT",
...
func (s *websocketServiceTestSuite) TestWsCombinedContinuousKlineServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedContinuousKlineServe(input, func(event *WsContinuousKlineEvent) {
		e := &WsContinuousKlineEvent{
			Event:        "continuous_kline",
			Time:         1499404907056,
			PairSymbol:   "ETHBTC",
...
func (s *websocketServiceTestSuite) TestMiniMarketTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsMiniMarketTickerServe("BTCUSDT", func(event *WsMiniMarketTickerEvent) {
...
func (s *websocketServiceTestSuite) TestAllMiniMarketTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllMiniMarketTickerServe(func(event WsAllMiniMarketTickerEvent) {
		e := []*WsMiniMarketTickerEvent{{
			Event:       "24hrMiniTicker",
			Time:        123456789,
			Symbol:      "BTCUSDT",
...
func (s *websocketServiceTestSuite) TestMarketTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsMarketTickerServe("BTCUSDT", func(event *WsMarketTickerEvent) {
...
func (s *websocketServiceTestSuite) TestAllMarketTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllMarketTickerServe(func(event WsAllMarketTickerEvent) {
...
func (s *websocketServiceTestSuite) TestBookTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsBookTickerServe("BNBUSDT", func(event *WsBookTickerEvent) {
		e := &WsBookTickerEvent{
			Event:           "bookTicker",
			UpdateID:        400900217,
			Time:            1568014460893,
...
func (s *websocketServiceTestSuite) TestAllBookTickerServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllBookTickerServe(func(event *WsBookTickerEvent) {
		e := &WsBookTickerEvent{
			Event:           "bookTicker",
			UpdateID:        400900217,
			Time:            1568014460893,
...
func (s *websocketServiceTestSuite) TestLiquidationOrderServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsLiquidationOrderServe("BTCUSDT", func(event *WsLiquidationOrderEvent) {
...
func (s *websocketServiceTestSuite) TestAllLiquidationOrderServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsAllLiquidationOrderServe(func(event *WsLiquidationOrderEvent) {
		e := &WsLiquidationOrderEvent{
			Event: "forceOrder",
			Time:  1568014460893,
			LiquidationOrder: WsLiquidationOrder{
...
func (s *websocketServiceTestSuite) testPartialDepthServe(rate *time.Duration, expectedErr error, expectedServeCnt int) {
	...
	var err error
	if rate == nil {
		doneC, stopC, err = c.WsPartialDepthServe("BTCUSDT", 5, handler, errHandler)
	} else {
		doneC, stopC, err = c.WsPartialDepthServeWithRate("BTCUSDT", 5, *rate, handler, errHandler)
	}
...
func (s *websocketServiceTestSuite) testDiffDepthServe(rate *time.Duration, expectedErr error, expectedServeCnt int) {
	...
	var err error
	if rate == nil {
		doneC, stopC, err = c.WsDiffDepthServe("BTCUSDT", handler, errHandler)
	} else {
		doneC, stopC, err = c.WsDiffDepthServeWithRate("BTCUSDT", *rate, handler, errHandler)
	}
...
func (s *websocketServiceTestSuite) TestWsCombinedDiffDepthServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCombinedDiffDepthServe(symbols, func(event *WsDepthEvent) {
		e := &WsDepthEvent{
			Event:            "depthUpdate",
			Time:             1628847118038,
...
func (s *websocketServiceTestSuite) TestBLVTInfoServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsBLVTInfoServe("TRXDOWN", func(event *WsBLVTInfoEvent) {
		e := &WsBLVTInfoEvent{
			Event:          "nav",
			Time:           1600245286355,
			Symbol:         "TRXDOWN",
...
func (s *websocketServiceTestSuite) TestBLVTKlineServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsBLVTKlineServe("TRXDOWN", "1m", func(event *WsBLVTKlineEvent) {
		e := &WsBLVTKlineEvent{
			Event:  "kline",
			Time:   1600243159447,
			Symbol: "TRXDOWN",
...
func (s *websocketServiceTestSuite) TestWsCompositiveIndexServe() {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsCompositiveIndexServe("TRXDOWN", func(event *WsCompositeIndexEvent) {
...
func (s *websocketServiceTestSuite) testWsUserDataServe(data []byte, expectedEvent *WsUserDataEvent) {
	...
	c := NewClient("", "")
	doneC, stopC, err := c.WsUserDataServe("fakeListenKey", func(event *WsUserDataEvent) {
